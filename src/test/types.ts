  ...
  public: {
    Tables: {
      ...
      job_postings: {
        ...
        Relationships: [
          {
            foreignKeyName: "job_postings_alumni_id_fkey"
            columns: ["alumni_id"]
            isOneToOne: false
      ...
      mentorship_offers: {
        ...
        Relationships: [
          {
            foreignKeyName: "mentorship_offers_alumni_id_fkey"
            columns: ["alumni_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      connections: {
        ...
        Relationships: [
          {
            foreignKeyName: "connections_profile_one_id_fkey"
          ...
          {
            foreignKeyName: "connections_profile_two_id_fkey"
    ...
    Enums: {
      app_role: "admin" | "user" | "student" | "alumni"
    }
    CompositeTypes: {
      [_ in never]: never
    }
