...
export const useUnreadMessages = (connectionId, profileId) => {
...
export const useAllConnectionsUnreadMessages = (connections = [], profileId) => {
    const [allUnreadCounts, setAllUnreadCounts] = useState({});
    useEffect(() => {
        if (!profileId)
            return;
        const newCounts = {};
    ...
    const syncUnreadCount = (connectionId, count) => {
